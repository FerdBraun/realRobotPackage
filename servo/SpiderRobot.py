...
class SpiderRobot:
    ...
    def step_forward(self, step_length=15, step_height=25):
    ...
    def step_backward(self, step_length=15, step_height=25):
        """Walk backward using tripod gait"""
        # 1. Lift first tripod
        self.lift_tripod(self.tripod1, step_height)
        time.sleep(self.movement_delay)
        ...
        # 5. Push body with first tripod
        self.move_tripod_forward(self.tripod1, step_length)
        
        # 6. Move second tripod backward
        self.move_tripod_backward(self.tripod2, step_length)
        time.sleep(self.movement_delay)
        ...
        # 9. Push body with second tripod
        self.move_tripod_forward(self.tripod2, step_length)
    ...
    def turn_left(self):
        """Turn left in place"""
        self.turn_in_place(direction='left', turn_angle=15, step_height=25)
    
    def turn_right(self):
        """Turn right in place"""
        self.turn_in_place(direction='right', turn_angle=15, step_height=25)

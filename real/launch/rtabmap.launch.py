...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/kinect/image_raw',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/kinect/depth/image_raw', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/kinect/camera_info',            description=''),
